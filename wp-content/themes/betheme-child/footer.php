...
<?php wp_footer(); ?>
<script src="https://use.fontawesome.com/1fb98f091b.js"></script>
<script>
	jQuery( ".shop-filters" ).append( "<button class='btn-filter'>Filter <span class='fa fa-filter'></span></button>" );
	jQuery(".btn-filter").click(function(){
		jQuery(".sidebar ").addClass("active");
	});
	jQuery( ".mcb-sidebar.sidebar" ).append( "<button class='btn-filter-close'> <span class='fa fa-close'></span></button>" );
	jQuery( ".mcb-sidebar.sidebar .widget-area" ).prepend( "<h2 class='filter-title'> Filters</h2>" );
