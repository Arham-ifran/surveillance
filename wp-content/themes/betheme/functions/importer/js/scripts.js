(function($) {
  ...
  $(function() {
    ...
    $('.demos', importer).on('click', '.item:not(.active)', function(e) {
      ...
      // hide steps, show first

      $('.content-step', el).hide().first().show();
      $('.select-builder li', el).removeClass('active').first().addClass('active');

      $('#input-builder', importer).val('');

      $(this).removeAttr('data-builder');
    ...
    $('.demos', importer).on('click', '.close, .cancel', function(e) {
    ...
    $('.select-builder', importer).on('click', 'li', function(e) {

      var item = $(this).closest('.item');

      if ( ! $( e.target ).is('a') ) {

        $('#input-builder', importer).val( $(this).data('builder') );

        $(this).addClass('active')
          .siblings().removeClass('active');

        item.attr('data-builder', $(this).data('builder'));
     ...
     * Item | Install
     *
     * Next step if there is builder select
     */

    $('.mfn-button-install', importer).on('click', function(e) {

      var step = $(this).closest('.content-step');
